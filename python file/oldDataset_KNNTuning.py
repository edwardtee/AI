...
from sklearn.model_selection import StratifiedKFold, cross_validate, train_test_split, GridSearchCV, learning_curve
from sklearn.preprocessing import StandardScaler
from sklearn.metrics import (
    ConfusionMatrixDisplay, accuracy_score, confusion_matrix, make_scorer, roc_auc_score, precision_score, recall_score, f1_score, roc_curve
)
...
# ==========================
X = df[["Age", "Cholesterol"]]  # Example features, replace with actual column names
...
MODEL_DIR = Path("Tuning Result") / "Old Dataset" / "Two Features"
...
plt.savefig("OldDataset_confusion_matrix_sklearn.png", dpi=300, bbox_inches='tight')
...
plt.grid(True)
plt.savefig("OldDataset_AUC-ROC.png", dpi=300)